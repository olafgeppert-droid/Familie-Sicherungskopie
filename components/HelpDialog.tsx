    ...
    const sections = [
        ...
        },
        {
            ...
            content: [
                ...
                "<strong>👤 Personendaten zurücksetzen:</strong> Leert nur die Personenliste, behält aber App-Einstellungen und Struktur bei. Es werden keine Beispieldaten automatisch geladen.",
                "<strong>🗑️ App-Speicher löschen:</strong> Setzt wirklich alles zurück – ein kompletter Neustart, so als wäre die App frisch installiert."
            ]
        }
    ];
