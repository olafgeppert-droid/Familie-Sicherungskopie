...
// App version label injection (non-invasive)
const APP_VERSION = 'v81';
window.addEventListener('DOMContentLoaded', () => {
  const r = document.getElementById('versionRibbon');
  if (r) r.textContent = APP_VERSION;
  const b = document.getElementById('versionBelowTable');
