...
// Utility: iOS detection for native print/share
...
// ---- BEGIN imported print logic from v59r ----
...
// ----------
// ---- END imported print logic ----

// Bind print dialog buttons (override old handlers)
document.addEventListener('DOMContentLoaded', ()=>{
  const p = document.getElementById('btnPrint');
  if(p) p.onclick = openPrintDialog;
  const d = document.getElementById('btnDoPrint');
  if(d) d.onclick = (e)=>{ e.preventDefault(); document.getElementById('dlgPrint').close(); doPrint(); };
});
