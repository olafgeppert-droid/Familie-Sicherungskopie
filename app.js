...
async function doLogin(){
  ...
  try{
    ...
    renderAll();
  }catch(e){ pwdInput.value=""; loginMsg.textContent = "Falsches Passwort."; const card=document.querySelector(".login-card"); card.classList.add("shake"); setTimeout(()=>card.classList.remove("shake"), 350); pwdInput.focus(); }
}
